            ...
            try(CourseStore courseStore = new CourseStore(); UserStore userStore = new UserStore();
                ...
                if(!isRegistered){
                    ...
                    for(Assignment a: assignments) {
                        res.append("<tr><form action=\"new_assignment\" method=\"get\"><input type=\"hidden\" name=\"aid\" value=\"");
                        res.append(a.getAid());
                        res.append("\"><td><input type=\"hidden\" name=\"kid\" value=\"").append(courseID).append("\"><button type=\"submit\" class=\"btn\">").append(a.getName()).append("</button></td><td>");
                        String result = null;
                        Rate rate = null;
